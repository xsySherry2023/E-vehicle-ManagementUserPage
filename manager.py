...
class Manager():
    ...
    def timeUsedAnalysis(self, vehicleTypeName: str) -> int:
        ...
        vehicledataframe = vehicledataframe.copy()
    ...
    def vehicleAnalysis(self, vehicleTypeName: str, cityLocationId: int):
        ...
        avdata= ve_dataframe[ve_dataframe['vehicleStatusName']=='available']
        dadata = ve_dataframe[ve_dataframe['vehicleStatusName']=='damaged']
...
if __name__ == "__main__":
    ...
    try:
        ...
        #print(functiontest4)
        #print(functiontest5)
       # print(functiontest6_avaiable, functiontest6_damaged)
        #mySQL.loadVehicles()['']
